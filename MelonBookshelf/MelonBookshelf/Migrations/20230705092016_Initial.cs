    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Followers", x => x.Id1);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Followers_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Upvotes_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Upvotes_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "RequestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WantedResources", x => x.Id1);
                    table.ForeignKey(
                        name: "FK_WantedResources_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WantedResources_Resources_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Upvotes_RequestId",
                table: "Upvotes",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_WantedResources_Id",
                table: "WantedResources",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_WantedResources_ResourceId",
                table: "WantedResources",
                column: "ResourceId");
        }
