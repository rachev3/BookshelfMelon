...
namespace MelonBookshelf.Migrations
{
    ...
    [Migration("20230731124604_BackgroundTasksUpdate")]
    partial class BackgroundTasksUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MelonBookshelf.Data.BackgroundTask", b =>
                {
                    b.Property<int>("BackgroundTaskId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BackgroundTaskId"), 1L, 1);
            ...
            modelBuilder.Entity("MelonBookshelf.Data.DTO.ResourceDownloadHistory", b =>
                {
                    b.Property<int>("DownloadHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DownloadHistoryId"), 1L, 1);
                    ...
                    b.ToTable("ResourceDownloadHistory");
                });

            modelBuilder.Entity("MelonBookshelf.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("MelonBookshelf.Models.Upvote", b =>
                {
            ...
            modelBuilder.Entity("MelonBookshelf.Models.Follower", b =>
                {
                    b.HasOne("MelonBookshelf.Models.Request", "Request")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("MelonBookshelf.Models.Request", b =>
                {
                    b.HasOne("MelonBookshelf.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MelonBookshelf.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
